...
import 'package:flutter_workout_manager/presentation/widgets/text_field/mail_address_text_form_field.dart';
import 'package:flutter_workout_manager/presentation/widgets/text_field/password_text_form_filed.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
                    ...
                    try {
                      ...
                      if (context.mounted) {
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                              content: Text(
                                  'User registered successfully: ${userEmail.state}')),
                        );
                      }
                    } catch (e) {
                      // 登録に失敗した場合
                        ...
                        : () async {
                            try {
                              await ref
                                  ...
                                  .signIn(userEmail.state, userPassword.state);
                              if (context.mounted) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(
              ...
              OutlinedButton(
                  child: const Text(
                      'Check the calendar function without logging in',
